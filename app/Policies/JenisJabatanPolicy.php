...
class JenisJabatanPolicy
{
    ...
    {
        return $user->can('force_delete_jenis::jabatan');
    }
    ...
    {
        return $user->can('force_delete_any_jenis::jabatan');
    }
    ...
    {
        return $user->can('restore_jenis::jabatan');
    }
    ...
    {
        return $user->can('restore_any_jenis::jabatan');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, JenisJabatan $jenisJabatan): bool
    {
        return $user->can('replicate_jenis::jabatan');
    }
    ...
    {
        return $user->can('reorder_jenis::jabatan');
    }
